...
sl.onclick=function(){
    ...
    document.getElementById("book").style.animation="fadetoright";
    document.getElementById("book").style.animationDuration="1s";

    document.getElementById("book").style.animation="showtoright";
    document.getElementById("book").style.animationDuration="1s";
    document.getElementById("book").style.animationFillMode ="forwards";
